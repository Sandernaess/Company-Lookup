# Company Lookup
A simple .NET (C#) Minimal API made as a playground that I can further use for testing design patterns, AI/SDD and different approaches. 

The API currently fetches company information from Brønnøysundregistrene API.
